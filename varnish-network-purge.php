 ...
 * Description:       Purge the Varnish cache of a WordPress site or multisite network: automatic targeted purge when content changes, wildcard purge of the whole site/network from the admin (via the X-Purge-Method regex ban convention), and a token-protected trigger URL (curl / cron).
 * Version:           1.5.0
